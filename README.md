...
2. [MITRE ATT&CK Analysis with Atomic Red Team](https://github.com/rafsanthegeneral/splunkproject/tree/master/project%232-Atomic-Red-Team-Analysis) This project bridges the gap between offensive and defensive security by executing simulated cyber attacks using Red Canary's **Atomic Red Team** framework. By triggering specific techniques mapped directly to the **MITRE ATT&CK** matrix on a Windows endpoint, this lab demonstrates how a Security Analyst tracks malicious footprints, parses telemetry, and crafts robust **Splunk SPL queries** to detect active adversarial behaviors in real time.

3.[Windows Web Server Compromise Investigation](https://github.com/rafsanthegeneral/splunkproject/blob/master/project%233-Windows-Web-Server-Compromise-Investigation.md) "The objective of this project is to leverage Splunk to identify compromised web server behavior, verify security breaches, and analyze relevant activity logs.
