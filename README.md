...
3.[Windows Web Server Compromise Investigation]() "The objective of this project is to leverage Splunk to identify compromised web server behavior, verify security breaches, and analyze relevant activity logs.
